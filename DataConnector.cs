...
/// see examples of pushing data to:
...
public class DataConnector : MonoBehaviour
{
    ...
    public class GazeData
    {
        ...
        public string ToCSV()
        {
            ...
            sb.Append(objectid);
            sb.Append(",");
            sb.Append(gazepoint.ToString().Replace(',','|'));
            sb.Append(",");
            sb.Append(hmdpoint.ToString().Replace(',','|'));
            sb.Append(",");
            sb.Append(hmdrotation.ToString().Replace(',','|'));
            sb.Append(",");
            sb.Append(hitSky);
            return sb.ToString();
        }
    ...
    public class FixationData
    {
        ...
        public string ToCSV()
        {
            ...
            sb.Append(DynamicObjectId);
            sb.Append(",");
            sb.Append(WorldPosition.ToString().Replace(',','|'));
            sb.Append(",");
            sb.Append(LocalPosition.ToString().Replace(',','|'));
            return sb.ToString();
        }
        public string ToJson()
        {
    ...
    public class EyeData
    {
        ...
        public string ToCSV()
        {
            ...
            sb.Append(type);
            sb.Append(",");
            sb.Append(hmdPos.ToString().Replace(',','|'));
            sb.Append(",");
            sb.Append(worldPoint.ToString().Replace(',','|'));
            sb.Append(",");
            sb.Append(hitDynamicId);
            sb.Append(",");
            sb.Append(localPoint.ToString().Replace(',','|'));
            sb.Append(",");
            sb.Append(screenPos.ToString().Replace(',','|'));
            sb.Append(",");
            sb.Append(viewportPos.ToString().Replace(',','|'));
            return sb.ToString();
        }
        public string ToJson()
        {
    ...
    public class EventData
    {
        ...
        public string ToCSV()
        {
            ...
            sb.Append(name);
            sb.Append(",");
            sb.Append(pos.ToString().Replace(',','|'));
            sb.Append(",");
            sb.Append(dynamicObjectId);
            sb.Append(",");
            sb.Append(propertyCount);
            sb.Append(",");
            sb.Append(keyValuePairs.ToString().Replace(',','|'));
            return sb.ToString();
        }
        public string ToJson()
        {
    ...
    public class BoundaryData
    {
        ...
        public string ToCSV()
        {
            ...
            sb.Append(pointCount);
            sb.Append(",");
            sb.Append(points.ToString().Replace(',','|'));
            return sb.ToString();
        }
        public string ToJson()
        {
